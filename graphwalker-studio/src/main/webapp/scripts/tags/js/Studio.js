...
riot.tag('connection-subpane', '<h5>GraphWalker settings</h5> <ul> <li><input name="ws_url" __disabled="{ connected }" type="text"> <li><a href="" onclick="{ toggle(\'showTextarea\') }">{showTextarea ? \'Hide\' : \'Show\'} connection log</a></li> <li show="{showTextarea}"><textarea name="output" readonly="true"></textarea></li> </ul>', 'connection-subpane button.connect, [riot-tag="connection-subpane"] button.connect{ width: 75px; } connection-subpane textarea[name=\'output\'], [riot-tag="connection-subpane"] textarea[name=\'output\']{ width: 285px; min-height: 100px; resize: vertical; border: 0; outline: none; } connection-subpane input[name=\'ws_url\'], [riot-tag="connection-subpane"] input[name=\'ws_url\']{ width: 210px; }', function(opts) {
        var ConnectionActions = require('actions/ConnectionActions');
