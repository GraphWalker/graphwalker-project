...
The jar is in:
```bash
graphwalker-cli/target/graphwalker-cli-4.1.0.jar
```

Run it like:
```bash
java -jar graphwalker-cli/target/graphwalker-cli-4.1.0.jar
```
...
Run it like:
```bash
java -jar graphwalker-studio/target/graphwalker-studio-4.1.0.jar
```
