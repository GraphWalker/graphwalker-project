...
public class MultipleContextTest {
  ...
  public void seededMultipleContexts() throws Exception {
    ...
    Context context1 = new TestExecutionContext(model1, new RandomPath(123456789, new EdgeCoverage(100))).setNextElement(A1);
    Context context2 = new TestExecutionContext(model2, new RandomPath(987654321, new EdgeCoverage(100))).setNextElement(A2);
